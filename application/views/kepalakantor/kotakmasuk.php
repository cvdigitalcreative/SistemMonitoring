            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
               ...
               <div class="pull-right">
                  <a href="<?php echo base_url(); ?>KepalaKantor/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
     ...
     <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pages/widgets.html">
            <i class=""></i>  <a href="<?php echo base_url(); ?>KepalaKantor" > <span>Kotak Masuk</span></a>
         ...
         <li>
          <a href="pages/widgets.html">
            <i class=""></i> <a href="<?php echo base_url(); ?>KepalaKantor/laporan" > <span>Laporan</span></a>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;"><?php echo $row->judullaporan;?></td>
                         ...
                         <td> 
                            ...
                            <div class="btn-group"> 
                              <?php echo form_open('KepalaKantor/download_laporan'); ?>
                         ...
                         <td>
                            <div class="btn-group"> 
                              <?php echo form_open('KepalaKantor/update_status'); ?>
